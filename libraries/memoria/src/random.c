...
/* This is quite the opposite to ONS_ROT. Well, you can achieve
 * the same results with both but this one is definitely faster
 * for small right rotations.
 */
...
void mem_isaac_seed(mem_isaac_t *ctx) {
    ...
    mem_isaac_rand(ctx); /* fill in the first set of results */
